...
# Census block paths
us_census_path = Path('../inputs/census_blocks/united_states/us_census_blocks_with_schools.gpkg')
canada_census_path = Path('../inputs/census_blocks/canada/Canada_census_blocks_with_schools.gpkg')
...
# Save tile list
tile_list_file = '../outputs/text/required_building_tiles_from_census.txt'
...
rsync_pattern_file = '../outputs/text/rsync_include_pattern_lod1_only.txt'
...
mapping_file = '../outputs/text/tile_to_filename_mapping.txt'
